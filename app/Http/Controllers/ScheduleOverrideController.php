...
class ScheduleOverrideController extends Controller
{
    ...
    public function update(Request $request, ScheduleOverride $override)
    {
        $request->validate([
            'doctor_id' => 'required|exists:users,id',
            'override_date' => 'required|date',
        ...
        return redirect()->route('dashboard.schedules.overrides.index')->with('success', 'Schedule Override updated successfully.');
    }
